...
def agent_activision(ip: str, agent: str, boolean: bool = False, name_csv: str = "Agent_properties.csv") -> bool:
    try:
        # Load the CSV file into a DataFrame
        df = pd.read_csv(name_csv)
...
def mapping_ip_to_agent(ip: str, name_csv: str = "Agent_properties.csv"):
    """
...
def find_row_of_data_frame_by_type_agent(list_type: List[str], person_block: List[Friend], name_csv: str = "Agent_properties.csv") -> pd.DataFrame:
    """
...
def generate_markdown_table(name_csv: str = "Agent_properties.csv"):
    """
